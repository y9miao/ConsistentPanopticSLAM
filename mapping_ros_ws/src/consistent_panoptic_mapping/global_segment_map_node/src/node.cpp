...
int main(int argc, char** argv) {
  ...
  std::string log_file_ = "/home/yang/990Pro/results_10/005/VppRunTime";
  node_handle.param<std::string>("gsm_node/log_folder", log_file_, "/home/yang/990Pro/results_10/005/VppRunTime");

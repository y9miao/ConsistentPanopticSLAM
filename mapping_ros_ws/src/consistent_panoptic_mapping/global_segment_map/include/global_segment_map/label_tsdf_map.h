  ...
  explicit LabelTsdfMap(const Config& config)
      : tsdf_layer_(
        ...
        highest_instance_(0u){
          semantic_instance_label_fusion_.inst_association_ = config.inst_association;
          semantic_instance_label_fusion_.use_inst_label_connect_ = config.use_inst_label_connect;
          semantic_instance_label_fusion_.connection_ratio_th_ = config.connection_ratio_th;
        }

...
def prepareSettingFile( scene_folder, orbslam_config_template_file):
    ...
    orbslam_config['Camera1.fx'] = 544.47329
    orbslam_config['Camera1.fy'] = 544.47329
    orbslam_config['Camera1.cx'] = 320.0
    orbslam_config['Camera1.cy'] = 240.0
...
def main():
    ...
    DataFolder = "/home/yang/scenenn_seg_76_raw"
    seqs_names =  ['011', '021', '065', '032', '093', '246', '086', '069', '206', \
     '252', '273', '527', '621', '076', '082', '207', '213', '272', '074']
    ...
    for seq in seqs_names:
        scene_folder = os.path.join(DataFolder, seq)
        prepareSettingFile( scene_folder, orbslam_config_template)

    # execute mapping 
    exe_file = "/home/yang/toolbox/test_field/volumetric-semantically-consistent-3D-panoptic-mapping/mapping_ros_ws/src/orbslam_semantic/scripts/OrbSlamForSceneNN/orbslam_sceneNN.sh"
    exe_commands = []
    ...
    for seq in seqs_names:
        ...
        color_folder = os.path.join(seq_folder, "image")

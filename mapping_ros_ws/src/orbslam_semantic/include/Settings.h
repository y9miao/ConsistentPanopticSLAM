...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        int trackMode() {return tracking_mode_;}
        bool trackDebug() { return tracking_debug_;}
    ...
    private:
        ...
        void readTrackMode(cv::FileStorage &fSettings);
        void readTrackDebug(cv::FileStorage &fSettings);

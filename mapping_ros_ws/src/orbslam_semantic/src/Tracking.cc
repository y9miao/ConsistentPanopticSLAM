...
void Tracking::Track()
{
    ...
    if(mState==OK || mState==RECENTLY_LOST)
    {
        ...
        if(mCurrentFrame.isSet())
        {
            ...
            frame_ids_list.push_back(int(mCurrentFrame.mTimeStamp));
            ...
            inlier_ratio_list.push_back(mCurrentFrame.inlier_ratio_);
            inlier_nums_list.push_back(mCurrentFrame.num_inliers_);
            covariance_list.push_back(mCurrentFrame.covariance_matrix_);
        }
        else
        {
...
bool Tracking::TrackLocalMap()
{
    ...
    {
        if(mSensor == System::RGBD)
            Optimizer::PoseOptimizationStereo(&mCurrentFrame, mCurrentFrame.mapPoints_residual_,
                mCurrentFrame.covariance_matrix_, mCurrentFrame.inlier_ratio_, mCurrentFrame.num_inliers_);
        else
            Optimizer::PoseOptimization(&mCurrentFrame);
    }

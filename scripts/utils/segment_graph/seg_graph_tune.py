...
class SegGraph:
    def __init__(self, instances_info, labels_info, confidence_map, semantic_instance_map, \
        semantic_updated_segs = [],  log_io = None,  BackgroundSemLabel = 80, \
    ...
    def refineLIMC3BreakAllReunion(self):
        ...
        log_info = "using parameter: " + str(connect_threshold_label_side) + "_" + \
        ...
        for instance_l in instances_info_refined:
            ...
            if (len(instance_info['labels'])!=0) and (instance_info['semantic']<self.background_semantic_label):

...
python ${EVAL_WS}/EvaluationMy/GeoSemEvalSegGraph.py \
	...
	--semantic_mesh_proj ${ResultFoldder}/${EvaluationFolder}/semantic_mesh_proj.ply \
	--base_folder ${BaseFolder} \
	--use_semantic $UseSemantic \
	--task ${Task}

# rm ${ResultFoldder}/${EvaluationFolder}/instance_mesh_proj.ply
# rm ${ResultFoldder}/${EvaluationFolder}/semantic_mesh_proj.ply
...
def parse_args():
    ...
    parse.add_argument("--instance_mesh_proj", type=str, default="", help="result projected mesh ")

    parse.add_argument("--base_folder", type=str,required=True,help="folder of base mapping results")
    parse.add_argument("--semantic_mesh_proj", type=str,required=True,help="base projected semantic_mesh of mapping results")
...
def main():
    ...
    result_instance_proj_f = args.instance_mesh_proj

    base_folder = args.base_folder
    result_semantic_proj_f = args.semantic_mesh_proj
